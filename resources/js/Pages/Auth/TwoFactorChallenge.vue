    ...
    <AuthenticationCard>
        ...
        <v-form @submit.prevent="submit" v-model="formValid">
            <v-card-text v-if="!recovery">
                <v-text-field v-model="form.code" type="text" inputmode="numeric" autofocus
...
<!--            <div v-if="! recovery">
            ...
            <v-card-text v-else>
                <v-text-field v-model="form.recovery_code" type="text" autocomplete="one-time-code" />
            </v-card-text>
<!--            <div v-else>
            ...
            <v-card-actions class="justify-space-between">
                ...
                <v-btn color="primary" type="submit" :disabled="!formValid || form.processing" :loading="form.processing">
                    Log In
                </v-btn>
            </v-card-actions>
